...
async function recorrerRegistros(inicio, fin, onRows) {
  ...
  // NO hacemos COUNT exact antes de empezar. En rangos largos (9 meses,
  // años, etc.) ese COUNT obliga a PostgreSQL a recorrer potencialmente
  // cientos de miles o millones de filas antes de entregar la primera
  // página y era el principal motivo de las esperas/timeout.
  //
  // La paginación real ya usa cursor (keyset) + índice por fecha/hash, por
  // lo que podemos empezar a procesar inmediatamente. El total queda en 0
  // y el frontend muestra el progreso por registros/páginas hasta terminar.
  const total = 0;
