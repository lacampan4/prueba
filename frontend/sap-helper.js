...
(function () {
  ...
  // Antes el valor por defecto era 'https://dasboard-lacampana.onrender.com' (una
  ...
  const API_BASE = (window.LC_API_BASE || 'https://dasboard-lacampana.onrender.com').replace(/\/$/, '');
