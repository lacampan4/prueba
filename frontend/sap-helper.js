...
(function () {
  ...
  function setButton(button, text, disabled) {
    ...
    // Compatibilidad interna para manejar documentos incrustados, marcos y mensajes entre páginas.
  ...
  // Funciones relacionadas con la carga y lectura de archivos.
  // Procesamiento y preparación de datos para el tablero.
