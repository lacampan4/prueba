...
(function () {
  ...
  function initExcelBridge() {
    // El bundler de estas páginas reemplaza el <html> después de DOMContentLoaded.
    // Por eso no basta con inicializar una sola vez: esperamos a que aparezcan
    // el botón y el modal y luego enlazamos el mismo importador del dashboard.
    ...
    if (!modal || !input || !drop || !button) return false;
